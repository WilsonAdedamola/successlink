      ...
      <div
        ...
        className={
          showPackages || value
            ...
            : "bg min-h-screen pb-6 overflow-y-hidden md:pb-3 px-4"
        }
      >
        <div className="2xl:max-w-[70%] 2xl:gap-9 flex flex-col justify-center pt-10 gap-4 mx-auto sm:px-7 md:flex-row md:items-center md:justify-between lg:pt-20">
          <p
            id="explore"
            className="flex flex-col gap-2 items-start font-bold text-3xl sm:text-4xl md:text-6xl lg:text-7xl"
          >
            GO Explore, <span>It's a big world</span> <span>Out there</span>
          </p>
          <p
            id="quote"
            className="flex flex-col items-start self-end sm:text-xl md:self-"
          >
        ...
        <div
          id="see-more"
          className="flex flex-col items-center gap-5 md:gap-10 justify-between rounded-3xl mt-7 bg-white py-6 lg:py-8 px-4 md:mt-32 md:rounded-full md:flex-row lg:max-w-full 2xl:max-w-[60%] mx-auto 2xl:mt-60"
        >
          ...
          <div className="flex flex-col items-center justify-center font-bold gap-4 md:gap-0 w-full md:flex-row md:mr-10">
            ...
            <div
              id="button"
              className="bg-[#992288] rounded-full py-2 md:py-3 w-full md:-ml-10 md:w-[50%]"
            >
              <button
